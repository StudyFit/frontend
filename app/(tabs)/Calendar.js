...
const schedules = [
  ...
  // 정채영 화/목/토 일정 (6월 3, 5, 7, 10, 12, 14, 17, 19, 21, 24, 26, 28)
  {
    connectionId: 2,
    calendarId: 14,
    date: "2025-06-03",
...
const homework = [
  ...
  },
  {
    ...
    homeworkList: [
      {
        homeworkId: 1,
        content: "쎈 수학 p.53-56 풀어오기",
        isCompleted: true,
        isPhotoRequired: false,
      },
      {
        homeworkId: 2,
        content: "개념원리 예제 3-6 풀어오기",
        isCompleted: true,
        isPhotoRequired: false,
      },
    ],
  ...
  // 정채영 숙제 (수업 있는 날 중 6월 3~8일까지만, 모두 완료)
  ...["2025-06-03", "2025-06-05", "2025-06-07"].map((date, idx) => ({
    connectionId: 2,
    homeworkDateId: 200 + idx,
    name: "정채영",
    info: null,
    subject: "수학",
    date,
              ...
              <View style={{ gap: 2 }}>
                ...
                {classShow &&
                  daySchedules.map((item) => (
                    <DayScheduleElement
                      key={item.calendarId}
                      themeColor={colors[item.themeColor]}
